# Stats and plot generation for computational experiment 6
# 
...
ggsave("CE6_ensemble_precision.tiff",width = 15, height = 6, units = "cm", dpi = 600)
...
ggsave("CE6_ensemble_accuracy.tiff",width = 15, height = 6, units = "cm", dpi = 600)
